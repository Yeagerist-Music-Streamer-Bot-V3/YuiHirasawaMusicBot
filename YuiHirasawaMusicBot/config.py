...
PROJECT_NAME = getenv("PROJECT_NAME", "Yui Hirasawa Music Vr 4")
SOURCE_CODE = getenv("SOURCE_CODE", "https://github.com/Yeagerist-Music-Streamer-Bot-V3/YuiHirasawaMusicBot")
